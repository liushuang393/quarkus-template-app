...
public interface AuditLogMapper {
     ...
     * 監査ログを挿入
     */
    @Insert("INSERT INTO audit_logs (user_id, username, action, resource_type, resource_id, " +
            "details, ip_address, user_agent, request_id, status, error_message, created_at) " +
            "VALUES (#{userId}, #{username}, #{action}, #{resourceType}, #{resourceId}, " +
            "#{details}, #{ipAddress}, #{userAgent}, #{requestId}, #{status}, #{errorMessage}, #{createdAt})")
     ...
     * IDで監査ログを検索
     */
    @Select("SELECT id, user_id, username, action, resource_type, resource_id, " +
            "details, ip_address, user_agent, request_id, status, error_message, created_at " +
